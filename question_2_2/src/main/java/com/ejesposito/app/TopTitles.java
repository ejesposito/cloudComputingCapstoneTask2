...
public final class TopTitles {
  ...
  public static void main(String[] args) {
    ...
    // Count the number of on time departure fligths from X to Y
    ...
    // mapToPair <"Ori,Des", 1> -> reduceByKey <"Ori,Des", partial sum> -> updateStateByKey <"Ori,Des", sum>
    ...
    // <"Ori,Des", sum> transform to <"Ori", "Des,sum">
   ...
   @DynamoDBTable(tableName="TopAirportByAirport")
